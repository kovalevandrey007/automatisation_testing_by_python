...
folder_in = "/home/andy/tst"
folder_out = "/home/andy/out"
folder_ext = "/home/andy/folder1"
folder_ext2 = "/home/andy/folder2"
...
def test_step1():
    # test1
    res1 = checkout("cd {}; 7z a {}/arx2".format(folder_in,
...
def test_step2():
    # test2
    res1 = checkout("cd {}; 7z e arx2.7z -o{} -y".format(folder_out,
                    folder_ext), "Everything is Ok")
...
def test_step3():
    # test3
    assert checkout("cd {}; 7z t arx2.7z".format(
        folder_out), "Everything is Ok"), "test3 FAIL"


def test_step4():
    # test4
    assert checkout("cd {}; 7z u arx2.7z".format(
        folder_in), "Everything is Ok"), "test4 FAIL"
...
def test_step5():
    # test5
    res1 = checkout("cd {}; 7z l arx2.7z".format(
        folder_out, folder_ext), "test1.txt")
    res2 = checkout("cd {}; 7z l arx2.7z".format(
        folder_out, folder_ext), "test2.txt")
    assert res1 and res2, "test5 FAIL"


def test_step6():
    # test6
    res1 = checkout("cd {}; 7z x arx2.7z -o{} -y".format(folder_out,
                    folder_ext2), "Everything is Ok")
...
def test_step7():
    # test7
    assert checkout("cd {}; 7z d arx2.7z".format(
        folder_out), "Everything is Ok"), "test7 FAIL"


def test_step8():
    # test8
    res1 = checkout("cd {}; 7z h test1.txt".format(
        folder_in), "Everything is Ok")
